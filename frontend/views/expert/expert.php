        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card border-0 rounded-0 hover-shadow">
                    <img class="card-img-top rounded-0" src="images/experts/expert-1.jpg" alt="expert">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card border-0 rounded-0 hover-shadow">
                    <img class="card-img-top rounded-0" src="images/experts/expert-2.jpg" alt="expert">
                    <div class="card-body">
                        <a href="expert-single.html">
            ...
            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card border-0 rounded-0 hover-shadow">
                    <img class="card-img-top rounded-0" src="images/experts/expert-3.jpg" alt="expert">
                    <div class="card-body">
                        <a href="expert-single.html">
